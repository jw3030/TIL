...
public class OrderVO {
	...
	public String toString() {
		return "OrderVO [orderno=" + orderno + ", ordermethod=" + ordermethod + ", memberid=" + memberid + ", prodcode="
				+ prodcode + ", prodname=" + prodname + ", quantity=" + quantity + ", order_group_no=" + order_group_no
				+ "]";
	}
